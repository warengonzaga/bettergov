...
const translations: Record<LanguageType, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle':
      'The Unofficial Portal of the Republic of the Philippines. Find information, access government services, stay updated with the latest news about the Philippines.',
