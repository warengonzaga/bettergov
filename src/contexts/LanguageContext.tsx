...
const translations: Record<LanguageType, Record<string, string>> = {
  en: {
    ...
    'hero.title': 'Welcome to the Official Portal of the Republic of the Philippines',
  ...
  fil: {
    ...
    'hero.title': 'Maligayang Pagdating sa Opisyal na Portal ng Republika ng Pilipinas',
